...
uniform vec3 color_GxColorRegister1;
uniform vec3 color_GxColorRegister0;
uniform float scalar_GxMaterialAlpha0;
uniform float scalar_GxAlphaRegister1;
...
void main() {
  ...
  vec3 colorComponent = clamp((color_GxMaterialColor0*clamp((individualLightDiffuseColors[2].rgb + color_GxAmbientColor1), 0, 1) + color_GxColorRegister1*(vec3(1) + vec3(-1)*(color_GxMaterialColor0*clamp((individualLightDiffuseColors[0].rgb + color_GxAmbientColor0), 0, 1) + vec3(-0.5))) + color_GxColorRegister0*(color_GxMaterialColor0*clamp((individualLightDiffuseColors[0].rgb + color_GxAmbientColor0), 0, 1) + vec3(-0.5)))*vec3(2), 0, 1);

  float alphaComponent = scalar_GxMaterialAlpha0 + scalar_GxAlphaRegister1*(1 + -1*(vertexColor0.a + vertexColor0.a + 0.5)) + scalar_GxAlphaRegister0*(vertexColor0.a + vertexColor0.a + 0.5);
