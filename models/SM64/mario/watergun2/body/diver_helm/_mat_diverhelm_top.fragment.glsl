...
void main() {
  ...
  vec3 colorComponent = clamp(texture(texture0, uv0).rgb + clamp((color_GxColorRegister4 + texture(texture1, uv0).rgb*(vec3(1) + vec3(-1)*vec3(0.375)) + color_GxMaterialColor0*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + color_GxAmbientColor0), 0, 1)*vec3(0.375) + vec3(-0.5)), 0, 1)*(vec3(1) + vec3(-1)*vec3(0.2980392156862745,0.4235294117647059,0.3803921568627451)) + color_GxMaterialColor0*clamp((individualLightDiffuseColors[2].rgb + color_GxAmbientColor1), 0, 1)*vec3(0.2980392156862745,0.4235294117647059,0.3803921568627451) + vec3(-0.5), 0, 1);
