...
void main() {
  ...
  vec3 colorComponent = clamp((color_GxMaterialColor1*clamp((individualLightDiffuseColors[2].rgb + clamp(color_GxAmbientColor1, 0, 1)), 0, 1) + clamp((vertexColor0.rgb*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + color_GxAmbientColor0), 0, 1) + vec3(-1)*vertexColor0.rgb*clamp((individualLightDiffuseColors[0].rgb + individualLightDiffuseColors[1].rgb + color_GxAmbientColor0), 0, 1)*vec3(0.5372549019607843,0.5411764705882353,0.5647058823529412)), 0, 1)*vec3(0.5372549019607843,0.5411764705882353,0.5647058823529412))*vec3(2), 0, 1);

  float alphaComponent = scalar_GxMaterialAlpha1 + vertexColor0.a;
